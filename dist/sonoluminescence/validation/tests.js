...
exports.testPlasmaFrequency = testPlasmaFrequency;
 ...
 */
function testAdiabaticCompression() {
    try {
        ...
        const result = (0, integrator_1.integrateRK4)((t, x) => model.rhs(t, x), x0, { dt: 1e-10, tMax: 1e-8 });
        // Check final state
...
function testSahaEquilibrium() {
    try {
        ...
        const n_e_expected = units_1.Calculations.numberDensityFromPressure(units_1.Calculations.idealGasPressure(n_neutral, T), T) * 0.1; // Rough estimate
...
function testEnergyConservation() {
    try {
        ...
        const result = (0, integrator_1.integrateRK4)((t, x) => model.rhs(t, x), x0, { dt: 1e-9, tMax: period });
 ...
 */
function testPlasmaFrequency() {
    try {
        const ne = 1e26; // High electron density
        const omega_p = units_1.Calculations.plasmaFrequency(ne);
        // Expected: ωp = sqrt(ne * e² / (ε0 * me))
        const e = units_1.Constants.e;
        const epsilon_0 = units_1.Constants.epsilon_0;
        const m_e = units_1.Constants.m_e;
