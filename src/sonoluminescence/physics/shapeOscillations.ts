...
export interface ShapeOscillationParams {
  ...
  // Natural frequencies (if not computed)
  omega2_natural?: number;  // Quadrupole natural frequency [rad/s]
  omega4_natural?: number;  // Hexadecapole natural frequency [rad/s]
  
  // Damping coefficients
  damping2?: number;  // Quadrupole damping [1/s]
  damping4?: number;  // Hexadecapole damping [1/s]
  
  // Advanced features
  enableNonlinearCoupling?: boolean; // Nonlinear mode-mode interactions
  enableShapeRadialCoupling?: boolean; // Energy exchange with radial mode
  enableAcousticCoupling?: boolean; // Coupling to acoustic field
 ...
 */
function computeNaturalFrequency(
  n: number,  // Mode number (2 for quadrupole, 4 for hexadecapole)
 ...
 */
export function computeShapeOscillationDerivatives(
  state: BubbleFullState,
  params: ShapeOscillationParams
): ShapeOscillationDerivatives {
 ...
 */
export function computeShapeEnergy(
  shape: ShapeOscillationState,
  R: number,
  rho: number
): number {
